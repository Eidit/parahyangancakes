...
<!DOCTYPE html>
	...
	<body>
		...
		<table align="center" border="0" cellpadding="1" style="width: 700px;">
			<tbody>
				...
				<span style="font-family: Verdana; font-size: x-small;"><b><h1>RIDO BANDUNG FURNITURE</h1></b></span></div>
        <span style="font-family: Verdana; font-size: x-small;"><h3>LAPORAN TRANSAKSI</h3></span>
        <span> 085387799996</span></br>
        <span> Jl. Teuku Umar No.58, Nunukan, Kalimantan Utara</span>
				<hr color="black"></td>
				</tr>
			</tbody>
		</table>
 ...
 ?>
    <div align="right">
    	...
    	<span align="center">Rido Bandung</span>
    </div>
	</body>
	<script>
		 window.load = print_d();
