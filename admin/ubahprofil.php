...
$ambil=$koneksi->query("SELECT*FROM toko WHERE id_toko='$id_admin'");
...
<form method="post" enctype="multipart/form-data">
	<div class="row">
		...
		<div class="form-group">
			<label >Telepon</label>
			<input type="number" name="telepon" class="form-control" value="<?php echo $detpem['telepon'] ?>">
		</div>
		...
		<div class="form-group">
			...
			<textarea type="text" class="form-control" name="alamat"><?php echo $detpem['alamat'] ?></textarea>
		</div>
...
if (isset($_POST["ubah"])) 
{
	...
	$koneksi->query("UPDATE toko SET distrik_id='$id_distrik', namatoko='$nama', email='$email', telepon='$telepon', provinsi='$_POST[provinsi]', tipe='$tipe',  distrik='$distrik', alamat='$alamat', fotoprofil='$fototoko'");

	}
 	else{

 	$koneksi->query("UPDATE toko SET distrik_id='$id_distrik', namatoko='$nama', email='$email', telepon='$telepon', provinsi='$_POST[provinsi]', tipe='$tipe',  distrik='$distrik', alamat='$alamat'");
 	}
