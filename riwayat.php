		    ...
		    <div class="tab">
		       <table id="table1" class="table table-bordered">
					...
					<tbody>
						<?php $nomor=1;
						$id_pelanggan= $_SESSION["pelanggan"]['id_pelanggan'];
						 $ambil= $koneksi->query("SELECT *FROM pembelian WHERE id_pelanggan='$id_pelanggan' AND status_pembelian='diproses'");
						while($pecah=$ambil->fetch_assoc()){?>
						<tr>
							<td><?php echo $nomor; ?></td>
							<td><?php echo date("d F Y", strtotime($pecah['tanggal_pembelian']))?></td>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="https://api.whatsapp.com/send?phone=<?php echo $pecah['resipengiriman']?>"><?php echo $pecah['resipengiriman']?></a>	
								<?php endif ?>
							</td>
							<td>Rp. <?php echo number_format($pecah["total_pembelian"]);?></td>
							<td>
								<a href="nota.php?id=<?php echo $pecah["id_pembelian"] ?>" class="btn btn-info">Nota</a>
								<a href="lihat_pembayaran.php?id=<?php echo $pecah["id_pembelian"]?>" class= "btn btn-success">Bukti</a>
								<a class="btn btn-primary" href="terima.php?id_pembelian=<?php echo $pecah['id_pembelian']; ?>" >Diterima</a>
							</td>
						</tr>
						<?php $nomor++;?>
						<?php  }?>
		      ...
		      <table id="table" class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="nota.php?id=<?php echo $pecah["id_pembelian"] ?>" class="btn btn-info">Nota</a>
								<a class="btn btn-danger" href="hapusbatal.php?id_pembelian=<?php echo $pecah['id_pembelian']; ?>" ><li class="fa fa-trash"></li></a>
							</td>
						</tr>
						<?php $nomor++;?>
						<?php  }?>
